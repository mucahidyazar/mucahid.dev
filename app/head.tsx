export default function Head() {
  return (
    <>
      {/* metatags.io */}
      {/* Primary Meta Tags */}
      <title>Mucahid Yazar - Frontend developer | mucahid.dev</title>
      <meta name="title" content="Mucahid Yazar - Frontend developer | mucahid.dev" />
      <meta name="description" content="I create accessible, user-friendly web applications with the best efficient solutions and best practices of the frontend world for SAAS projects." />
