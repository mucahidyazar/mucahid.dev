  ...
  return (
    <S.HelpContainer>
      <S.HelpContainerSection>
        <S.HelpContainerSectionTitle id="privacy" level={2}>
          Privacy Policy
        </S.HelpContainerSectionTitle>
        <S.HelpContainerSectionDescription>
      ...
      <S.HelpContainerSection>
        <S.HelpContainerSectionTitle level={2}>
          Interpretation and Definitions
        </S.HelpContainerSectionTitle>
        <S.HelpContainerSectionTitle id="interpretation" level={3}>
          Interpretation
        </S.HelpContainerSectionTitle>
        <S.HelpContainerSectionDescription>
        ...
        <S.HelpContainerSectionTitle id="definitions" level={3}>
          Definitions
        </S.HelpContainerSectionTitle>
        <S.HelpContainerSectionDescription>
          For the purposes of this Privacy Policy:
        </S.HelpContainerSectionDescription>
        <S.HelpContainerSectionList>
          <S.HelpContainerSectionListItem>
            <S.HelpContainerSectionDescription>
          ...
          <S.HelpContainerSectionListItem>
            <S.HelpContainerSectionDescription>
              ...
              in this Agreement) refers to mucahid.dev.
            </S.HelpContainerSectionDescription>
          </S.HelpContainerSectionListItem>
          <S.HelpContainerSectionListItem>
            <S.HelpContainerSectionDescription>
          ...
          <S.HelpContainerSectionListItem>
            <S.HelpContainerSectionDescription>
              <strong>Website</strong> refers to mucahid.dev, accessible from{' '}
              <S.HelpContainerSectionLink
      ...
      <S.HelpContainerSectionDescription></S.HelpContainerSectionDescription>
      <S.HelpContainerSectionTitle level={2}>
        Collecting and Using Your Personal Data
      </S.HelpContainerSectionTitle>
      <S.HelpContainerSectionTitle level={3}>
        Types of Data Collected
      </S.HelpContainerSectionTitle>
      <S.HelpContainerSectionTitle level={4}>
        Personal Data
      </S.HelpContainerSectionTitle>
      <S.HelpContainerSectionDescription>
      ...
      <S.HelpContainerSectionTitle id="cookie" level={4}>
      ...
      <S.HelpContainerSectionList>
        <S.HelpContainerSectionListItem>
          <S.HelpContainerSectionDescription>
            By email: mucahidyazar@gmail.com
          </S.HelpContainerSectionDescription>
        </S.HelpContainerSectionListItem>
        <S.HelpContainerSectionListItem>
          <S.HelpContainerSectionDescription>
      ...
      <S.HelpContainerSection>
        <S.HelpContainerSectionTitle id="faq" level={2}>
          FAQ (Frequently Asked Questions)
        </S.HelpContainerSectionTitle>

        <S.HelpContainerSectionQuestion>
          Is this blog an open source project?
        </S.HelpContainerSectionQuestion>
        <S.HelpContainerSectionDescription>
          Yes It is an open source project. You can check the code from its
          repository page. Here is the repository link:
          <S.HelpContainerSectionLink
            href="https://github.com/mucahidyazar/mucahid.dev.git"
            rel="external nofollow noopener"
            target="_blank"
          >
            mucahid.dev
        ...
        <S.HelpContainerSectionDescription>
          ...
          <S.HelpContainerSectionLink
            href="mailto:mucahidyazar@gmail.com"
            rel="external nofollow noopener"
            target="_blank"
          >
