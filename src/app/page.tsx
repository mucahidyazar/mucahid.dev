              ...
              <Tooltip
                content={
                  <div className="w-96">
                    ...
                    frontend development everything get more complex and easier
                    in time. As a part of this community I want to develop to
                    solve these complex problems and make this easier than
                    today. And also the other best motivated thing is thriving
                    on the challenge of solving complex problems and seeing my
                    work come to life in a polished, functional end-product.
                  </div>
                }
              ...
              <Tooltip
                content={
                  <div className="w-96">
                    ...
                    Documented projects so having good and smooth flow for
                    anyone • Analyzing and monitoring your frontend applications
                    and taking action before time is too late • Experience
                    worked on the projects that has millions requests each day •
                    Accessible forms and applications • Full automated workflow
                    your frontend applications with CI/CD and your deployment
                    tool • Applying similar codebases and single source of truth
                  </div>
                }
                key="offer-tooltip"
              >
              ...
              <Tooltip
                content={
                  <ul className="w-96 list-disc pl-2">
                    ...
                    <li>
                      Created a company and engineering culture from scratch for
                      a startup. I built their documentation as a template,
                      teach them some daily and development habits.
                    </li>
                    <li>
                      Automated release process and version management. This is
                      a monorepo example: If PR is merged to main; (1 and 2 are
                      working as parallel)
                      <ul className="list-decimal list-inside">
                        <li>
                          Create a changelog for apps which has any file changes
                          <ul className="list-inside pl-6">
                            <li>
                              If there is any changes under /libs/ui, then start
                              npm publish process
                            </li>
                          </ul>
                        </li>
